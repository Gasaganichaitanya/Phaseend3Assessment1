...
using ASSESSMENT1PHASE3.Data;
using ASSESSMENT1PHASE3.Models;

namespace ASSESSMENT1PHASE3.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DeptMastersController : ControllerBase
    {
        private readonly DeptMasterContext _context;

        public DeptMastersController(DeptMasterContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<DeptMaster>> PostDeptMaster(DeptMaster deptMaster)
        {
          if (_context.DeptMaster == null)
          {
              return Problem("Entity set 'DeptMasterContext.DeptMaster'  is null.");
          }
